...
function BooksCardSlider() {
  const scriptures = [
    ...
    },
    {
        ...
        imageSrc: vedas1,
        downUrl:"https://www.adsensecustomsearchads.com/afs/ads?psid=5134551505&channel=AutoRsVariant&cx=r-8741a2d083ed0b653&fexp=42532561%2C21404%2C17301431%2C17301432%2C17301436&client=pub-7001470329354026&r=m&hl=en&rpbu=http%3A%2F%2Fgoogle.com&rpqp=q&type=3&rs_tt=c&oe=UTF-8&ie=UTF-8&client_gdprApplies=0&format=r5&nocache=1891716368348865&num=0&output=afd_ads&domain_name=www.holybooks.com&v=3&bsl=10&pac=0&u_his=2&u_tz=330&dt=1716368348866&u_w=1707&u_h=1067&biw=1692&bih=995&psw=1692&psh=49230&frm=0&uio=-&cont=autors-container-0&drt=0&jsid=csa&nfp=1&jsv=633245794&rurl=https%3A%2F%2Fwww.holybooks.com%2Frig-veda%2F&referer=https%3A%2F%2Fwww.bing.com%2F#&nb=0&nm=53&is=985x347&nx=70&ny=22"
      },
      {
  ...
  return (
    <section className="text-gray-600 body-font bg-gray-100 p-5">
      ...
      <div className="container px-5 py-20 mx-auto max-w-8xl">
